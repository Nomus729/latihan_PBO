...
$daftarNasabah = array(
    ...
    2 => new Tabungan(2, "Eko Nugroho", 1200000, "5678"),
    3 => new Tabungan(3, "Dani Abdul", 750000, "9012"),
);

while (true) {
    echo "========================================\n";
    echo "   Aplikasi Tabungan Mahasiswa Sederhana   \n";
    echo "========================================\n";
    ...
    $pilihanNasabah = getInput("Pilih no nasabah (atau 'q' untuk keluar): ");

    if (strtolower($pilihanNasabah) === 'q') {
